"""
scripts/create_ops_manager.py
Seed script para crear el perfil genérico provisional del rol manager_ops.

Uso:
    python scripts/create_ops_manager.py
...
_USERNAME        = "ops.manager"
_PASSWORD_PLAIN  = "AdamoOps2026*"
_NOMBRE_COMPLETO = "Equipo Operaciones (Provisional)"
_EMAIL           = "operaciones-test@adamopay.com"
_ROL             = "manager_ops"
